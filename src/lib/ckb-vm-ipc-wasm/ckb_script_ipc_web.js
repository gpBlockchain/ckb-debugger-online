/* @ts-self-types="./ckb_script_ipc_web.d.ts" */

export class ExecuteResult {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ExecuteResult.prototype);
        obj.__wbg_ptr = ptr;
        ExecuteResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
     ...
     */
    get cycles() {
        const ret = wasm.executeresult_cycles(this.__wbg_ptr);
     ...
     */
    get debug_messages() {
        const ret = wasm.executeresult_debug_messages(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {string}
    ...
    get json_response() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.executeresult_json_response(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ckb_script_ipc_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ckb_script_ipc_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
