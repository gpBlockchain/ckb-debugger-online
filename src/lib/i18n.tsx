...
const en: TranslationDict = {
  ...
  // IPC Playground
  "ipc.step1New": "1. Load Mock Transaction",
  "ipc.mockTxHelpNew": "The IPC server script must be referenced in the mock_tx (as a cell_dep). Fetch a transaction from the chain or upload a mock_tx.json file.",
  ...
  "ipc.demoDescriptionNew": "Load a mock_tx containing the IPC server contract, then send a request. Use TxFetcher to get a transaction from testnet.",
  "ipc.demoSourceCode": "Contract Source Code",
  "ipc.loadDemo": "Load Demo",
  "ipc.demoLoadedNew": "Demo payload loaded — fetch a mock_tx first, then Execute",
...
const zh: TranslationDict = {
  ...
  // IPC Playground
  "ipc.step1New": "1. 加载 Mock 交易",
  "ipc.mockTxHelpNew": "IPC 服务端脚本必须在 mock_tx 中被引用（作为 cell_dep）。可从链上获取交易或上传 mock_tx.json 文件。",
  ...
  "ipc.demoDescriptionNew": "加载包含 IPC 服务端合约的 mock_tx，然后发送请求。使用 TxFetcher 从测试网获取交易。",
  "ipc.demoSourceCode": "合约源码",
  "ipc.loadDemo": "加载 Demo",
  "ipc.demoLoadedNew": "Demo 载荷已加载 — 先获取 mock_tx，然后执行",
  "ipc.scriptGroup": "脚本组",
