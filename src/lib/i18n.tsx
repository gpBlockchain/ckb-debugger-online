...
const en: TranslationDict = {
  ...
  "ipc.step1": "1. Load Script Binary",
  "ipc.step2": "2. Server Arguments",
  "ipc.argsHelp": "Comma-separated arguments passed to the script (e.g. server_entry)",
  "ipc.step3": "3. JSON Request",
  "ipc.requestHelp": "Enter the JSON-formatted IPC request to send to the server",
  "ipc.execute": "Execute",
  "ipc.clear": "Clear",
  "ipc.wasmReady": "Script IPC WASM module is ready",
  "ipc.wasmNotAvailable": "Script IPC WASM Module Not Available",
  "ipc.runBuildScript": "Please run",
  "ipc.executionSuccess": "Execution completed successfully",
  "ipc.executionError": "Execution error",
  "ipc.jsonResponse": "JSON Response",
  "ipc.cyclesUsed": "Cycles Used",
  "ipc.executionTime": "Execution Time",
  "ipc.debugOutput": "Debug Output",
  "ipc.error.loadBinary": "Please load a script binary first",
  "ipc.error.enterRequest": "Please enter a JSON request",
...
const zh: TranslationDict = {
  ...
  "ipc.step1": "1. 加载合约二进制文件",
  "ipc.step2": "2. 服务端参数",
  "ipc.argsHelp": "传递给脚本的逗号分隔参数（例如 server_entry）",
  "ipc.step3": "3. JSON 请求",
  "ipc.requestHelp": "输入要发送给服务端的 JSON 格式 IPC 请求",
  "ipc.execute": "执行",
  "ipc.clear": "清除",
  "ipc.wasmReady": "Script IPC WASM 模块已就绪",
  "ipc.wasmNotAvailable": "Script IPC WASM 模块不可用",
  "ipc.runBuildScript": "请运行",
  "ipc.executionSuccess": "执行成功",
  "ipc.executionError": "执行出错",
  "ipc.jsonResponse": "JSON 响应",
  "ipc.cyclesUsed": "消耗 Cycles",
  "ipc.executionTime": "执行时间",
  "ipc.debugOutput": "调试输出",
  "ipc.error.loadBinary": "请先加载合约二进制文件",
  "ipc.error.enterRequest": "请输入 JSON 请求",
