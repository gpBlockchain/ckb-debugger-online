 ...
 * @returns {string}
 */
export function run_json(mock_tx, script_group_type, script_hash, max_cycle) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ret = wasm.run_json(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        deferred5_0 = ret[0];
        deferred5_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('ckb_debugger_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
